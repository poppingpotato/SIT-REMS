        ...
        <div class="col-md-12 grid-margin">
            <div class="d-flex justify-content-between align-items-center">
                <div class="p-2 bd-highlight">
                    <a class="btn btn-primary" href="/student"><i class="fas fa-arrow-left"></i> Back</a>
                </div>
                
                <div class="">
                <form class="form-inline my-2 my-lg-0" type="get" action="{{ url('/studentssearch') }}">
                        <input class="form-control mr-sm-2" type="text" name="search-query-student" placeholder="Search">
