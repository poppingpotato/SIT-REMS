...
<div class="row">
    <div class="col-md-12 grid-margin">
        <div class="d-flex justify-content-between align-items-center">
            <div class="p-2 bd-highlight">
                <a class="btn btn-primary" btn-lg btn-block" href="{{ route('register') }}"><i class="fas fa-plus"></i> User</a>

            </div>

            <div class="p-2 bd-highlight">
                <a class="btn btn-success" href="/usersdata-pdf">Generate PDF <i class="far fa-file-pdf"></i></a>
            </div>
                    ...
                    @foreach($userQuery as $user)  
                        <tr>
                            ...
                            @elseif($user->is_admin == 1)
                                <td>Admin</td>
                                <td>
                                    <button type="button" id="btnEdit" class="btn btn-primary" btn-lg btn-block" data-id="{{$user->id}}"><i class="far fa-edit"></i></button>
                                    <button type="button" id="btnDelete" class="btn btn-danger" btn-lg btn-block" data-id="{{$user->id}}"><i class="far fa-trash-alt"></i></button>
                                </td>
                            @else
                                <td>User</td>
                                <td>
